    ...
    return (
        ...
        <div className="flex flex-col w-80 bg-gray-800 text-white flex-shrink-0">
            ...
            <div className="flex-grow p-6 overflow-y-auto">
                ...
                {/* Quick link to ATS Score Checker */}
                <div className="mt-6">
                    <h4 className="font-semibold mb-2">Quick Links</h4>
                    <Link to="/ats" className="flex items-center p-3 hover:bg-gray-700 rounded transition">
                        <FaRobot className="mr-3" />
                        <span className="ml-2">ATS Score Checker</span>
                    </Link>
                </div>
