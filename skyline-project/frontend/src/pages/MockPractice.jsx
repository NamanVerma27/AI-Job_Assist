...
function MockPractice() {
  ...
  const startSession = async () => {
    ...
    try {
      ...
      const res = await axios.post("/mock-v3/start", {
        ...
        interview_type: sessionConfig.interview_type, // Pass config
  ...
  const handleSubmitAnswer = async (answerText) => {
    pushMessage({ id: Date.now(), type: "user", text: answerText });
    setIsLoading(true);
          ...
          <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
              <div className="bg-white p-10 rounded-xl shadow-lg w-full max-w-lg">
                  ...
                  <div className="space-y-4">
                    ...
                    {/* TYPE & PERSONALITY SELECTORS */}
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-bold text-gray-600 mb-1">Interview Type</label>
                        ...
                        <div>
                            <label className="block text-sm font-bold text-gray-600 mb-1">Interviewer Persona</label>
                    ...
                    <button className="w-full bg-indigo-600 text-white px-6 py-3 rounded-lg font-bold hover:bg-indigo-700 transition" onClick={startSession} disabled={isLoading}>
      ...
      return (
          <div className="flex flex-col h-screen bg-gray-50">
              <SidebarStatus 
                  ...
                  difficulty={sessionConfig.difficulty}
              />
              <div className="flex-grow overflow-auto p-4" ref={timelineRef}>
                  <ChatTimeline messages={messages} />
                  {isTyping && <TypingIndicator />}
              </div>
              <AnswerBar onSubmit={handleSubmitAnswer} isLoading={isLoading} />
          </div>
      );
  }
